...
#define MPI3MR_DRIVER_VERSION	"8.13.1.0.0-45d2"
#define MPI3MR_DRIVER_RELDATE	"17-June-2025"
 ...
 * @ci: consumer index
 * @pi: producer index
 * @num_requests: Maximum number of entries in the queue
 ...
 * @poll_completions: Complete I/O in poll mode
