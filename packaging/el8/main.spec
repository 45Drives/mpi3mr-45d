...
%global PACKAGE_NAME "%(grep PACKAGE_NAME= $BUILDROOT/dkms.conf | cut -d= -f2 | cut -d'"' -f2)"
%global PACKAGE_VERSION "%(grep PACKAGE_VERSION= $BUILDROOT/dkms.conf | cut -d= -f2 | cut -d'"' -f2)"
